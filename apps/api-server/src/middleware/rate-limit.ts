...
async function checkRateLimit(
  ...
  const result = await cache.checkRateLimit(identifier, config.requests, config.windowSeconds);
 ...
 */
export function withRateLimitByIp(config: RateLimitConfig, handler: RouteHandler): RouteHandler {
