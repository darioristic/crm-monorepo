	...
	return {
		...
		entityType:
			row.entity_type || row.entityType
				? String(row.entity_type || row.entityType)
				: undefined,
		entityId:
			row.entity_id || row.entityId
				? String(row.entity_id || row.entityId)
				: undefined,
		isRead:
			row.is_read !== undefined ? Boolean(row.is_read) : Boolean(row.isRead),
		readAt:
			row.read_at || row.readAt ? String(row.read_at || row.readAt) : undefined,
		emailSent:
			row.email_sent !== undefined
				? Boolean(row.email_sent)
				: Boolean(row.emailSent),
		emailSentAt:
				...
				serviceLogger.error(
					{
						...
						errorMessage:
							countError instanceof Error
								...
								: String(countError),
						errorStack:
							countError instanceof Error ? countError.stack : undefined,
						userId,
						filters,
					},
				...
				serviceLogger.error(
					{
						...
						errorMessage:
							unreadError instanceof Error
								...
								: String(unreadError),
						errorStack:
							unreadError instanceof Error ? unreadError.stack : undefined,
						userId,
					},
				...
				serviceLogger.error(
					{
						...
						errorMessage:
							selectError instanceof Error
								...
								: String(selectError),
						errorStack:
							selectError instanceof Error ? selectError.stack : undefined,
						userId,
						filters,
						pagination,
					},
