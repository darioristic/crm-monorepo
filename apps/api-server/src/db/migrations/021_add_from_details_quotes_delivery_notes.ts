...
export async function up() {
  ...
  logger.info("✅ Migration 021: Added from_details to quotes and delivery_notes");
}
...
export async function down() {
  ...
  logger.info("✅ Migration 021: Removed from_details from quotes and delivery_notes");
}
