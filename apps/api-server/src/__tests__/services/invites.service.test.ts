...
describe("InvitesService", () => {
  ...
  describe("getInvites", () => {
    ...
    it("should handle database errors", async () => {
      vi.mocked(inviteQueries.findPendingByCompany).mockRejectedValue(new Error("DB Error"));
  ...
  describe("deleteInvite", () => {
    it("should delete an invite", async () => {
      ...
      const result = await invitesService.deleteInvite(mockInvite.id, mockCompanyId);
    ...
    it("should return 404 if invite not found", async () => {
      ...
      const result = await invitesService.deleteInvite("invalid-id", mockCompanyId);
  ...
  describe("acceptInvite", () => {
    it("should accept an invite", async () => {
      ...
      const result = await invitesService.acceptInvite("test-token", mockUserId);
    ...
    it("should return 404 if token invalid", async () => {
      ...
      const result = await invitesService.acceptInvite("invalid-token", mockUserId);
