		...
		<Card className="border-destructive/50 bg-destructive/5">
			<CardHeader className="pb-4">
				...
				<CardDescription className="text-sm">
					Permanently remove your company and all of its contents. This action is not reversible — please continue with caution.
				</CardDescription>
			</CardHeader>
			<CardContent>
				<p className="text-sm text-muted-foreground leading-relaxed">
					Once you delete a company, there is no going back. All data, members, and settings will be permanently removed.
				</p>
			</CardContent>
					...
					<AlertDialogContent>
						<AlertDialogHeader>
							...
							<AlertDialogDescription>
								...
								company and remove all data from our servers.
							</AlertDialogDescription>
						</AlertDialogHeader>
