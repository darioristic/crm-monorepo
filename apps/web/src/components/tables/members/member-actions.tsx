...
import { deleteCompanyMember, leaveCompany, updateCompanyMember } from "@/lib/companies";
    ...
    <div className="flex justify-end">
      <div className="flex space-x-2 items-center">
        {canChangeRole && !isCurrentUser ? (
          ...
          >
            <SelectTrigger>
              <SelectValue placeholder={member.role || "member"} />
            </SelectTrigger>
            <SelectContent>
          ...
          <span className="text-sm text-[#606060]">{member.role || "member"}</span>
        )}
        {canManage && (
          <DropdownMenu>
                ...
                <AlertDialog>
                  ...
                  <AlertDialogContent>
                    <AlertDialogHeader>
                      ...
                      <AlertDialogDescription>
                        You are about to remove the following Team Member, are you sure you want to
                        continue?
                      </AlertDialogDescription>
                    </AlertDialogHeader>
                    <AlertDialogFooter>
                  ...
                  <AlertDialogContent>
                    ...
                    <AlertDialogFooter>
                      ...
                      <AlertDialogAction
                        ...
                        onClick={() => leaveTeamMutation.mutate(member.companyId)}
                      >
