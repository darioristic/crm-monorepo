    ...
    <Card className="border-border/50 bg-muted/30">
      ...
      <CardContent>
        <p className="text-sm text-muted-foreground leading-relaxed">
          You will be automatically added as the owner and can switch between companies at any time
          from the company dropdown.
        </p>
      </CardContent>
      <CardFooter className="flex justify-end border-t pt-4">
        <Button onClick={() => setParams({ createCompany: true })} className="gap-2">
