  ...
  const inviteMutation = useMutation({
    ...
    onSuccess: (data) => {
      ...
      if (data.sent > 0 && data.skipped === 0) {
        ...
        toast.info(
          `${data.sent} invite${data.sent > 1 ? "s" : ""} sent, ${data.skipped} skipped (already members or invited)`
        );
      } else if (data.sent === 0 && data.skipped > 0) {
        toast.warning(
          `All ${data.skipped} invite${data.skipped > 1 ? "s" : ""} were skipped (already members or invited)`
        );
      }
