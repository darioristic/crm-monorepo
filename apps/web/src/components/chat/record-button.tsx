...
// Animated Record Icon with wave animation
const RecordIcon = ({
  size = 16,
  isRecording = false,
}: {
...
export function RecordButton({
  ...
  }, [isRecording, stopRecording, startRecording, transcribeAudio, onTranscription]);
  ...
  return (
    <Button
      ...
      disabled={disabled}
      className={cn(
        "h-8 w-8 transition-all duration-300 hover:bg-transparent text-muted-foreground",
